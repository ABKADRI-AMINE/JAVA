...
public class client1 extends javax.swing.JFrame {
    ...
    String userNamee ;
    //static int vertical_step = 10;
    static Box vertical = Box.createVerticalBox();
    //static Box vertical2 = Box.createVerticalBox();
    ...
    private void initComponents() {
        ...
        user_area = new javax.swing.JPanel();
        ...
        javax.swing.GroupLayout user_areaLayout = new javax.swing.GroupLayout(user_area);
        user_area.setLayout(user_areaLayout);
        user_areaLayout.setHorizontalGroup(
            user_areaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 349, Short.MAX_VALUE)
        );
        user_areaLayout.setVerticalGroup(
            user_areaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        title.setText("The_full_user_name_client");
     ...
     /*----------format guys connected ------------*/
           /* public  static JLabel UserLabel(){
            user_area.setBackground(new Color(255, 255, 255));
            JLabel l1 = new JLabel("My useRRRRRRRRRR");
            l1.setFont(new Font("Tahoma", Font.PLAIN, 12));
            l1.setBackground(new Color(255, 204, 204)); 
            //l1.setForeground(new Color(255, 255, 255));
            l1.setOpaque(true);
            l1.setBounds(10, vertical_step, 120, 30);
            System.out.println("vertical "+vertical_step);
            vertical_step += 50;
            return l1;
        }*/
    private void msg_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_msg_sendActionPerformed
           ...
           try{
            ...
            {
                System.out.println("saalut voila error "+e);
         }
          ...
          //while(true){
            ...
            reader = new BufferedReader(new InputStreamReader(s.getInputStream()));
             ...
             while (true) {
                ...
                String msg = text ;
                JPanel p2 = formatLabel(text,"to "+user);
    ...
    private static javax.swing.JPanel user_area;
