...
public class menuu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Relevés de notes ");
        jPanel13.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        jPanel2.add(jPanel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 340, 40));

        rSTableMetro3.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"19040510", "ABKADRI", "AMINE", "GI2", "2022", "Accepte"},
                {"19040510", "ABKADRI", "AMINE", "GI2", "2022", null},
                {"19040510", "ABKADRI", "AMINE", "GI2", null, null},
                {null, null, null, null, null, null}
            },
            new String [] {
                "Apogee", "Nom", "Prenom", "Filiere", "Annee Scolaire", "Etat"
            }
        ));
        ...
        jPanel2.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 790, 90));
        ...
        jLabel9.setText("Attestation de scolarite");
        jPanel9.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        jPanel2.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 340, 40));

        rSTableMetro4.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"19040510", "ABKADRI", "AMINE", "GI2", "2022", null},
                {"19040510", "ABKADRI", "AMINE", "GI2", "2022", null},
                {"19040510", "ABKADRI", "AMINE", "GI2", null, ""},
                {null, null, null, null, null, null}
            },
            new String [] {
                "Apogee", "Nom", "Prenom", "Filiere", "Annee Scolaire", "Etat"
        ...
        rSTableMetro4.setColorBackgoundHead(new java.awt.Color(97, 212, 195));
        rSTableMetro4.setColorFilasBackgound2(new java.awt.Color(97, 212, 195));
        rSTableMetro4.setColorFilasForeground1(new java.awt.Color(102, 102, 102));
        rSTableMetro4.setColorFilasForeground2(new java.awt.Color(255, 255, 255));
        rSTableMetro4.setColorSelBackgound(new java.awt.Color(97, 212, 195));
        rSTableMetro4.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        rSTableMetro4.setFuenteFilas(new java.awt.Font("Yu Gothic UI", 1, 12)); // NOI18N
        rSTableMetro4.setFuenteFilasSelect(new java.awt.Font("Yu Gothic UI", 1, 12)); // NOI18N
        rSTableMetro4.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
        rSTableMetro4.setRowHeight(40);
        jScrollPane4.setViewportView(rSTableMetro4);

        jPanel2.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 790, 90));
        ...
        jLabel10.setText("Attestation de reussite");
        jPanel10.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        jPanel2.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, 340, 40));
        ...
        rSTableMetro5.setColorBackgoundHead(new java.awt.Color(97, 212, 195));
        rSTableMetro5.setColorFilasBackgound2(new java.awt.Color(97, 212, 195));
        rSTableMetro5.setColorFilasForeground1(new java.awt.Color(102, 102, 102));
        rSTableMetro5.setColorFilasForeground2(new java.awt.Color(255, 255, 255));
        rSTableMetro5.setColorSelBackgound(new java.awt.Color(97, 212, 195));
        rSTableMetro5.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        rSTableMetro5.setFuenteFilas(new java.awt.Font("Yu Gothic UI", 1, 12)); // NOI18N
        rSTableMetro5.setFuenteFilasSelect(new java.awt.Font("Yu Gothic UI", 1, 12)); // NOI18N
        rSTableMetro5.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
        rSTableMetro5.setRowHeight(40);
        jScrollPane5.setViewportView(rSTableMetro5);

        jPanel2.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 790, 90));
        ...
        jLabel16.setText("Attestation de stage");
        jPanel14.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        jPanel2.add(jPanel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 340, 40));
        ...
        rSTableMetro6.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"19040510", "ABKADRI", "AMINE", "GI2", "VESEO", "PFA", "10-06-2022", "10-08-2022", null},
                {"19040510", "ABKADRI", "AMINE", "GI2", "VESEO", "PFA", "10-06-2022", "10-08-2022", null},
                {"19040510", "ABKADRI", "AMINE", "GI2", "VESEO", "PFA", "10-06-2022", "10-08-2022", null}
            },
            new String [] {
                "Apogee", "Nom", "Prenom", "Filiere", "Societe", "Type.Stage", "D.debut", "D.fin", "Etat"
            }
        ));
        rSTableMetro6.setColorBackgoundHead(new java.awt.Color(97, 212, 195));
        rSTableMetro6.setColorFilasBackgound2(new java.awt.Color(97, 212, 195));
        rSTableMetro6.setColorFilasForeground1(new java.awt.Color(102, 102, 102));
        rSTableMetro6.setColorFilasForeground2(new java.awt.Color(255, 255, 255));
        rSTableMetro6.setColorSelBackgound(new java.awt.Color(97, 212, 195));
        rSTableMetro6.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        rSTableMetro6.setFuenteFilas(new java.awt.Font("Yu Gothic UI", 1, 12)); // NOI18N
        rSTableMetro6.setFuenteFilasSelect(new java.awt.Font("Yu Gothic UI", 1, 12)); // NOI18N
        rSTableMetro6.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
        rSTableMetro6.setRowHeight(40);
        jScrollPane6.setViewportView(rSTableMetro6);

        jPanel2.add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 560, 790, 100));
